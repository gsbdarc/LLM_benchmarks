...
for benchmark_id in benchmarks.keys():
    for model_id in model_keys:
        for image_id in image_index.keys():
            ...
            row = [benchmark_id, benchmark_name, model_id, model_name, image_id, image_path]
...
headers = ["task_id", "benchmark_id", "benchmark_name", "model_id", "model_name", "image_id", "image_path"]
